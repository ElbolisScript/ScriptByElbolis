...
-- Window --
local Win = Blacklib:Window("Made by Elbolis")
-- Tab --
local Drop = Win:Tab("• auto Drop Items", img)
local Misc = Win:Tab("• Misc", img)
...
Drop:Toggle("Drop XOX Ball Rainbow", function(state)
    if state then
        _G.on = true
        while _G.on do
            wait(0.5)
...
Drop:Toggle("Drop F", function(state)
    if state then
        _G.on = true
        while _G.on do
            wait(0.5)
...
Drop:Toggle("Drop Box Toy harambe", function(state)
    if state then
        _G.on = true
        while _G.on do
            wait(0.5)
...
Drop:Toggle("Drop Dart", function(state)
    if state then
        _G.on = true
        while _G.on do
            wait(0.5)
...
Drop:Toggle("Drop Baby Yodo", function(state)
    if state then
        _G.on = true
        while _G.on do
            wait(0.5)
...
Drop:Toggle("Drop Friend Blue", function(state)
    if state then
        _G.on = true
        while _G.on do
            wait(0.5)
...
Drop:Toggle("Drop Gaming Chair", function(state)
    if state then
        _G.on = true
        while _G.on do
            wait(0.5)
...
Drop:Toggle("Drop Piano", function(state)
    if state then
        _G.on = true
        while _G.on do
            wait(0.5)
...
Drop:Toggle("Drop The banana", function(state)
    if state then
        _G.on = true
        while _G.on do
            wait(0.5)
...
Misc:Toggle("Auto Acept", function(state)
if state then
        _G.on = true
...
Misc:Button("Trade Value",function()
...
Misc:Button("Fly v2",function()
    loadstring(game:HttpGet("https://pastebin.com/raw/h5QDPy6s"))()
end)
Misc:Button("fake drop gui",function()
...
Misc:Button("safe place",function()
